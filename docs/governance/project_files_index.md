...
**Канонические файлы:**
- `project_summary_v_2_12.md` ← canonical
- `project_summary_v_2_11.md` ← superseded by v_2_12 (не архивирован)
...
- `session_closure_log_YYYY_MM_DD_v_X_Y.md` (каждый файл — уникальная дата; naming: mixed dots/underscores — исторически; не переименовываются)
  - Последний: `session_closure_log_2026_02_21_v_1_0.md`
...
- `filename_generation_policy_v_1_2.md` ← canonical (v_1_0, v_1_1 retained, immutable; superseded)
...
- `docs/policies/`
  ...
  - `filename_generation_policy_v_1_2.md` (canonical)
