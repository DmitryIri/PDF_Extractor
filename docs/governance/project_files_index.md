...
**Канонические файлы:**
- `project_summary_v_2_17.md` ← canonical
- `project_summary_v_2_16.md` ← superseded by v_2_17 (в `docs/state/`)
...
- `session_closure_log_YYYY_MM_DD_v_X_Y.md` (каждый файл — уникальная дата; naming: mixed dots/underscores — исторически; не переименовываются)
  ...
  - `session_closure_log_2026_04_04_v_1_0.md` (Q9 closure; UI Hardening Pass v1; публикация на pdf-extractor.irdimas.ru)
  - `session_closure_log_2026_04_04_v_1_1.md` (BoundaryDetector v1.3.2: forward-only window; Na_2026-03 T=L=E=7 via Web UI)
  - `session_closure_log_2026_04_05_v_1_0.md` (UI Hardening Pass v1 close + Pass v2; BoundaryDetector digest fix; HTMX SRI hash debug)
  - `session_closure_log_2026_04_05_v_1_1.md` (HTMX fix verification; Q10 closure; factual audit; critical-path doc-sync: BD v_1_4, project_summary v_2_17, project_files_index v_1_21)
  - Последний: `session_closure_log_2026_04_05_v_1_1.md`
...
- `pdf_extractor_boundary_detector_v_1_4.md` ← canonical
...
- `pdf_extractor_boundary_detector_v_1_3.md` ← superseded by v_1_4 (в `docs/design/`)
...
- **v_1_22 — 2026-04-05** — session_closure_log_2026_04_05_v_1_1.md добавлен (HTMX fix verification; Q10 closure; factual audit; critical-path doc-sync: BD v_1_4, project_summary v_2_17, project_files_index v_1_21); последний closure log обновлён в §2.B.
- **v_1_21 — 2026-04-05** — boundary_detector_v_1_4.md canonical (digest rule + forward-only window); project_summary_v_2_17.md canonical (BoundaryDetector v1.3.3, 7 production runs, UI Hardening Pass v1+v2, public URL); active pointers обновлены в §2.B, §2.D, §5.
- **v_1_20 — 2026-04-05** — session_closure_log_2026_04_05_v_1_0 добавлен (UI Hardening Pass v1 close + Pass v2 progress visibility; BoundaryDetector v1.3.3 digest fix; HTMX SRI hash debug); последний closure log обновлён в §2.B.
- **v_1_19 — 2026-04-04** — session_closure_log_2026_04_04_v_1_1 добавлен (BoundaryDetector v1.3.2: forward-only window в _has_contents_marker; Na_2026-03 T=L=E=7 через Web UI); последний closure log обновлён в §2.B.
- **v_1_18 — 2026-04-04** — session_closure_log_2026_04_04_v_1_0 добавлен (Q9 closure; UI Hardening Pass v1; публикация на pdf-extractor.irdimas.ru); последний closure log обновлён в §2.B.
