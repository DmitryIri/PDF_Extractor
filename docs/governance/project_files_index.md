...
**Канонические файлы:**
- `project_summary_v_2_11.md` ← canonical (v_2_6–v_2_10 — в `_archive/summaries/`)
...
- `pdf_extractor_techspec_v_2_6.md` ← canonical (v_2_5 и ранее — в `_archive/techspec/`)
- `pdf_extractor_plan_v_2_4.md` ← canonical (v_2_2, v_2_3 — в `_archive/plans/`)
- `pdf_extractor_boundary_detector_v_1_2.md` ← canonical (v_1_0, v_1_1 — в `_archive/design/`)
...
- `filename_generation_policy_v_1_1.md` ← canonical (v_1_0 retained, immutable; superseded)
...
- `docs/design/`
  - `pdf_extractor_techspec_v_2_6.md` (canonical)
  - `pdf_extractor_plan_v_2_4.md` (canonical)
  - `pdf_extractor_boundary_detector_v_1_2.md` (canonical)
...
- `docs/policies/`
  ...
  - `filename_generation_policy_v_1_1.md` (canonical)
