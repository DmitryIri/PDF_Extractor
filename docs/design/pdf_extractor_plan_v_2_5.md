# PDF Extractor — Plan v_2_5

**Статус:** Canonical (Self‑Contained)
**Дата:** 2026-03-04
**Фаза проекта:** Phase 2 Complete

---

## 1. Цель плана

Зафиксировать **исполняемую, детерминированную последовательность разработки PDF Extractor**, синхронизированную с **TechSpec v_2_7**.
...
Компоненты реализуются **строго в порядке, определённом TechSpec v_2_7**.
...
- info — editorial guidelines / journal announcements without extractable authors and no DOI
...
- Enrichment: first_author_surname, expected_filename (по FilenameGeneration Policy v_1_2)
...
- оформляются новой версией (v_2_5+);
- требуют синхронизации с TechSpec;
- фиксируются в project summary.

---

**Plan v_2_5 зафиксирован как Canonical.**
...
### v_2_5 — 2026-03-04
- §1, §2.1: TechSpec ref v_2_6 → v_2_7
- §5.5 material_kind: добавлен `info` — editorial guidelines / journal announcements without extractable authors and no DOI
- §5.7 MetadataVerifier: policy ref v_1_1 → v_1_2
- Supersedes v_2_4

### v_2_4 — 2026-02-06
- Synchronized with TechSpec v_2_6: version references, BoundaryDetector schema, material classification, MetadataVerifier enrichment
- Supersedes v_2_3
