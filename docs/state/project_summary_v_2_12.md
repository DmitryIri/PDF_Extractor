...
**Активная фаза:** Phase 2 полностью завершена (включая run-pipeline AC1-AC7, Mg_2026-01 issue processing) → Phase 3 (UI/DB) в подготовке
...
- BoundaryDetector v_1_2 (Canonical) — committed
