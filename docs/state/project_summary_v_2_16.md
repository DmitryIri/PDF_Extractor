...
**Активная фаза:** Phase 2 полностью завершена; Phase 3 (Web UI) — задеплоено (MVP)
...
- ✅ `docs/portfolio/upwork_project_1_description.md` — текст проекта для Upwork (~550 символов)
...
**Статус:** 🟡 Pending
**Описание:** Полное acceptance testing Phase 3 Web UI с реальным PDF через http://localhost:18080. AC1–AC7 по аналогии с run-pipeline skill.
...
**Production validated journals:** Mg (2025-12, 2026-01, 2026-02), Mh (2026-01, 2026-02, 2026-03), Na (2026-02)

**Phase 3 Web UI:** ✅ MVP задеплоено — FastAPI + SQLite + HTMX (commit 45b0a70)

**Pending:**
- Q7: UI AC1–AC7 acceptance testing с реальным PDF
