# Ops Router v_1_1 — Skill Routing & Reminders (Canonical)

**Supersedes:** ops_router_v_1_0.md
...
2) Run /session-close to draft session closure doc(s)
...
- **v_1_1 — 2026-02-04** — Fixed T2: `/session-closure-log` → `/session-close` (match actual skill name).
- **v_1_0 — 2026-01-22** — Initial canonical version.
